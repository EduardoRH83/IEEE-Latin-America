...
% Input 2: Power, Solar irradiance, Wind Direction, Heat Index.
...
input = CleanData(1:3300-Steps,[1 2 3 5]); %<=========================input
...
net.layers{1}.transferFcn = activateFcn;
...
for j = 0:l-1   
    ...
    for i = 1:Steps        
        ...
        ys = nets(xs,xis,ais);        
        X = CleanData(1:3300 - Steps + End + i,[1 2 3 5]); %<=========================input
...
%     n = size(Real,1);
    ...
    mse_for = meansqr(abs(Predicted) - Real);
