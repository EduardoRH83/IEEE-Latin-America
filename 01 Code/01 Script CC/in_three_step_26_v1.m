...
% Input 3: Power, Solar irradiance, Wind Direction, Pressure, Temperature.
...
input = CleanData(1:3300-Steps,[1 2 3 6 8]); %<=========================input
...
for j = 0:l-1   
    ...
    for i = 1:Steps        
        ...
        ys = nets(xs,xis,ais);        
        X = CleanData(1:3300 - Steps + End + i,[1 2 3 6 8]); %<=========================input
